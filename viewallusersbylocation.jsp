...
<div class="main">
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2><span>All Users Ordered By Location  </span></h2>
          <div class="clr"></div>
          <p>&nbsp;</p>
          <p>
	      ...
	      <table width="650" border="1"  cellpadding="0" cellspacing="0"  style="border-collapse: collapse; display:inline; margin:10px 0px 0px 0px; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:14px;">
					...
					%>
                      <tr>
						...
						%>
						 <td  width="10" valign="baseline" height="0" style="color:#000000;"align="center"><a href="generatekeyconfirm.jsp?uid=<%=i%>" title="Click here to make user Authorized">waiting&nbsp;</a></td>
                        <td  width="10" valign="baseline" height="0" style="color:#000000;"align="center"><a href="getuserdetails.jsp?id=<%=i%>" title="Click here to see  <%out.println(s1);%>  details">View Details&nbsp;</a></td>
                        <%
						}
						else
						{
		 ...
		 <h2>Welcome to<span style="color:#0066CC"> Admin</span></h2>
          ...
          <div class="clr"></div>
           <ul class="sb_menu">
            ...
            <li class="active"><a href="viewallusersbylocation.jsp">View Similar User Location </a></li>
