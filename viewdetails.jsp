	...
	while ( rs.next() )
	   {
		...
		Statement st3 = connection.createStatement();
		   String query3 ="update images set count="+j+" where id ="+one+"  ";
...
<table width="669" border="0" align="center">
  ...
  <tr>
    <td><div align="left" class="style5">Item Uses </div></td>
    <td><%=s5%></td>
  </tr>
  <tr>
    <td><div align="left" class="style5">Item Price </div></td>
    <td><%=s6%></td>
  </tr>
   <% if(ustatus.equalsIgnoreCase("Authorized")){ %>
  <tr>
  
    <td><div align="left" class="style5">Item Image  </div></td>
    <td>
      <div align="left">
  ...
  <tr>
    <td><div align="left" class="style5">Recommend to Friends</div></td>
    <td><div align="left"><a href="recommend.jsp?id=<%=i%>"><strong>Recommend&nbsp;</strong></a></div></td>
  </tr>
  <tr>
    <td><div align="left" class="style5">Intrest on Item</div></td>
    <td><div align="left"><a href="review.jsp?id=<%=i%>"><strong>Intrest</strong></a></div></td>
  </tr>
  <%
