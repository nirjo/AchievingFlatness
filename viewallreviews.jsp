...
<div class="main">
  <div class="header">
    <div class="logo">
      <h1><a href="#" class="style2">Achieving Flatness: Selecting the Honeywords from Existing User Passwords</a></h1>
    </div>
    <div class="menu_nav">
      <ul>
        <li></li>
  ...
  <div class="content">
    <div class="content_bg">
      <div class="mainbar">
        <div class="article">
          <h2>User Intrests On Items Based On Location </h2>
          <div class="clr"></div>
          <p>&nbsp;</p>
          <p><%
        ...
        <div class="gadget">
		 <h2>Welcome to<span style="color:#0066CC"> <%= application.getAttribute("uname")%></span></h2>
          ...
          <ul class="sb_menu">
            ...
            <li class="active"><a href="viewallreviews.jsp">View user interests on the Item. </a></li>
