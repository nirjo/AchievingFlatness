				...
				try {
					...
					File file1 = null;	
						...
						while (params.hasMoreElements()) 
						{
							...
							PreparedStatement ps=connection.prepareStatement("insert into images(itemtitle,itemcolor,itemdescription,itemuses,itemprice,imagess,count,binaryimage,imagetitle,uname) values(?,?,?,?,?,?,?,?,?,?)");
							ps.setString(1,a);
							ps.setString(2,b);
							ps.setString(3,c);	
							ps.setString(4,d);
